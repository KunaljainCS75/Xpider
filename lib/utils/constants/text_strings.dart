...
class TTexts {
  ...
  static const String about = "About yourself";
  ...
  static const String groupName = "Update Name";
  static const String groupDescription = "Update Description";


  // -- Authentication Headings
  static const String loginTitle = "Let's create a network with Xpider";
  static const String loginSubTitle = "Discover your friends and relations all over the world and talk limitless.";
  ...
  // -- Home
  static const String homeAppbarTitle = "Xpider Community";
  static const String homeAppbarSubTitle = "Kunal Kumar";
  static const String securityStatement = "Your Messages are end-to-end Encrypted.";
